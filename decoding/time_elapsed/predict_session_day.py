...
def parse_args():
    ...
    parser.add_argument('--nperms', type=int, default=5, help='Number of permutations to use.')
...
if __name__ == '__main__':
    ...
    path = Path(__file__)
    output_path= path.parent / "results_shuffled" / f'{args.trial_type}_{args.task}_session_day.pkl'
    ...
    # take the permutations most different from the original session list (spearman correlation between original and ) closest to 0
